...
namespace NFSLibrary.Protocols.V2.RPC
{
    ...
    /// <summary>
    /// Represents the status response for NFS v2 item operations.
    /// </summary>
    public class ItemOperationStatus : XdrAble
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemOperationStatus"/> class.
        /// </summary>
        public ItemOperationStatus()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="ItemOperationStatus"/> class by decoding from an XDR stream.
        /// </summary>
        ...
        /// <summary>
        /// Gets the operation result (available when status is NFS_OK).
        /// </summary>
