...
namespace NFSLibrary.Rpc
{
    ...
    public abstract class OncRpcReplyMessage : OncRpcMessage
    {
        ...
        {
            messageType = NFSLibrary.Rpc.OncRpcMessageType.ONCRPC_REPLY;
            replyStatus = NFSLibrary.Rpc.OncRpcReplyStatus.ONCRPC_MSG_ACCEPTED;
            acceptStatus = NFSLibrary.Rpc.OncRpcAcceptStatus.ONCRPC_SYSTEM_ERR;
        ...
        /// ).
        /// </param>
        public OncRpcReplyMessage(NFSLibrary.Rpc.OncRpcCallMessage call, int replyStatus
