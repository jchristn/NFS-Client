...
namespace NFSLibrary.Rpc
{
    ...
    /// issues.
    /// <para>Authentication on the client side can be done as follows: just
    ...
    public abstract class OncRpcClientAuth
    {
        ...
        internal abstract void XdrEncodeCredVerf(NFSLibrary.Rpc.XdrEncodingStream xdr);
        ...
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        internal abstract void XdrDecodeVerf(NFSLibrary.Rpc.XdrDecodingStream xdr);
