...
namespace NFSLibrary.Rpc
{
    ...
    public class OncRpcUdpClient : OncRpcClient
    {
        ...
        /// to the ONC/RPC server at <code>host</code> for calling remote procedures
        /// of the given { program, version }.
        /// <para>Note that the construction of an <code>OncRpcUdpProtocolClient</code>
        /// object will result in communication with the portmap process at
        /// <code>host</code> if <code>port</code> is <code>0</code>.</para>
        /// </remarks>
            ...
            .ONCRPC_UDP)
        {
            ...
            // Enable address reuse to help with socket exhaustion
                ...
                for (int refreshesLeft = 1; refreshesLeft >= 0; --refreshesLeft)
                {
                    ...
                    do
                    {
                        ...
                        for (; ; )
                        {
                                ...
                                if (host.Equals(receivingXdr.GetSenderAddress()))
                                {
                                    ...
                                    if (replyHeader.messageId == callHeader.messageId)
                                    {
                                        if (!replyHeader.successfullyAccepted())
                                        {
                                            ...
                                            // credentials.
                                            //
                                            if ((refreshesLeft > 0) && (replyHeader.replyStatus == NFSLibrary.Rpc.OncRpcReplyStatus
                                                .ONCRPC_MSG_DENIED) && (replyHeader.rejectStatus == NFSLibrary.Rpc.OncRpcRejectStatus
                            ...
                            catch (NFSLibrary.Rpc.OncRpcException e)
                            {
                                //
                                ...
                                //
                                if (e.getReason() != NFSLibrary.Rpc.OncRpcException.RPC_WRONGMESSAGE)
                                {
                                    throw;
                                }
                            }
                        ...
                        //
                        if (retransmissionMode == NFSLibrary.Rpc.OncRpcUdpRetransmissionMode.EXPONENTIAL)
                        {
                            resendTimeout *= 2;
                        }
                    }
        ...
        /// <see cref="OncRpcClient.SetTimeout(int)">OncRpcClient.SetTimeout(int)</see>
        /// expires without resending the reply.</para>
        /// <para>Note that you might experience unwanted results when using
        ...
        /// ONC/RPC calls, something you probably do not want at all.</para>
        /// </remarks>
        /// <param name="procedureNumber">Procedure number of the procedure to call.</param>
        /// <param name="params">
        /// The parameters of the procedure to call, contained
        ...
        /// <exception cref="OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public virtual void broadcastCall(int procedureNumber, NFSLibrary.Rpc.XdrAble @params
            , NFSLibrary.Rpc.XdrAble result, NFSLibrary.Rpc.OncRpcBroadcastListener listener
            )
        {
            lock (this)
            {
                ...
                //
                nextXid();
                NFSLibrary.Rpc.OncRpcClientCallMessage callHeader = new NFSLibrary.Rpc.OncRpcClientCallMessage
                    (xid, program, version, procedureNumber, auth);
                NFSLibrary.Rpc.OncRpcClientReplyMessage replyHeader = new NFSLibrary.Rpc.OncRpcClientReplyMessage
                    (auth);
                //
                ...
                {
                    throw (new NFSLibrary.Rpc.OncRpcException(NFSLibrary.Rpc.OncRpcException.RPC_CANTSEND
                        , e.Message));
                }
                //
                ...
                do
                {
                    try
                    {
                        ...
                        if (replyHeader.messageId == callHeader.messageId)
                        {
                            ...
                            if (listener != null)
                            {
                                NFSLibrary.Rpc.OncRpcBroadcastEvent evt = new NFSLibrary.Rpc.OncRpcBroadcastEvent
                        ...
                        else
                        {
                            ...
                            {
                                throw (new NFSLibrary.Rpc.OncRpcException(NFSLibrary.Rpc.OncRpcException.RPC_CANTRECV
                                    , e.Message));
                            }
                        }
                    }
        ...
        /// server.
        /// </remarks>
        internal NFSLibrary.Rpc.XdrUdpEncodingStream sendingXdr;
        ...
        /// ONC/RPC server.
        /// </remarks>
        internal NFSLibrary.Rpc.XdrUdpDecodingStream receivingXdr;
        ...
        internal int retransmissionMode = NFSLibrary.Rpc.OncRpcUdpRetransmissionMode.FIXED;
    }
}