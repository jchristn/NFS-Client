...
namespace NFSLibrary.Rpc
{
    ...
    /// anyway.
    /// <para>To use polymorphism with XDR streams, you'll have to derive your own base
    ...
    /// 	</see>
    /// . Do not overwrite
    /// the methods XdrEncode and XdrDecode!</para>
    /// <para>Then, in your <code>foo</code>-derived classes, like <code>bar</code>
    ...
    /// of your <code>foo</code> class.</para>
    ...
    public abstract class XdrUnion : NFSLibrary.Rpc.XdrAble
    {
        /// <summary>
        ...
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public abstract void XdrEncodeCommon(NFSLibrary.Rpc.XdrEncodingStream xdr);
        ...
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public abstract void XdrDecodeCommon(NFSLibrary.Rpc.XdrDecodingStream xdr);
        ...
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public abstract void XdrEncodeVariant(NFSLibrary.Rpc.XdrEncodingStream xdr);
        ...
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public abstract void XdrDecodeVariant(NFSLibrary.Rpc.XdrDecodingStream xdr);
    }
}