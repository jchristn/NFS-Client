...
namespace NFSLibrary.Rpc
{
    ...
    public abstract class OncRpcBroadcastAdapter : NFSLibrary.Rpc.OncRpcBroadcastListener
    {
        ...
        /// <seealso cref="OncRpcBroadcastEvent">OncRpcBroadcastEvent</seealso>
        public virtual void replyReceived(NFSLibrary.Rpc.OncRpcBroadcastEvent evt)
        {
        }
    }
}