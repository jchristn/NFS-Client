...
namespace NFSLibrary.Rpc
{
    ...
    public class OncRpcClientAuthNone : NFSLibrary.Rpc.OncRpcClientAuth
    {
        /// <summary>
        ...
        /// AUTH_NONE authentification for an ONC/RPC client.
        /// </remarks>
        public static readonly NFSLibrary.Rpc.OncRpcClientAuthNone AUTH_NONE = new NFSLibrary.Rpc.OncRpcClientAuthNone
            ();
    }
}