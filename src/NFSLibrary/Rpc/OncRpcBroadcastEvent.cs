...
namespace NFSLibrary.Rpc
{
    ...
    public class OncRpcBroadcastEvent
    {
        ...
        public OncRpcBroadcastEvent(NFSLibrary.Rpc.OncRpcUdpClient source, IPAddress
             replyAddress, int procedureNumber, NFSLibrary.Rpc.XdrAble @params, NFSLibrary.Rpc.XdrAble
             reply)
        {
        ...
        public virtual NFSLibrary.Rpc.XdrAble getReply()
        {
            return reply;
        }
        ...
        public virtual NFSLibrary.Rpc.XdrAble getParams()
        {
            return @params;
        }
        ...
        /// <serial></serial>
        private NFSLibrary.Rpc.XdrAble @params;
        ...
        /// </remarks>
        /// <serial></serial>
        private NFSLibrary.Rpc.XdrAble reply;
    }
}