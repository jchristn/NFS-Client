...
namespace NFSLibrary.Rpc
{
    ...
    public abstract class OncRpcClientStub
    {
        ...
        {
            client = NFSLibrary.Rpc.OncRpcClient.newOncRpcClient(host, program, version, port
        ...
        public OncRpcClientStub(NFSLibrary.Rpc.OncRpcClient client)
        {
            this.client = client;
        }
        ...
        public virtual NFSLibrary.Rpc.OncRpcClient GetClient()
        {
            return client;
        }
        ...
        /// IP protocol.
        /// </remarks>
        protected NFSLibrary.Rpc.OncRpcClient client;
    }
}