...
namespace NFSLibrary.Rpc
{
    ...
    [System.Serializable]
    public class OncRpcProgramNotRegisteredException : NFSLibrary.Rpc.OncRpcException
    {
        ...
        /// appropriate clear-text detail message.
        /// </remarks>
        public OncRpcProgramNotRegisteredException() : base(NFSLibrary.Rpc.OncRpcException
