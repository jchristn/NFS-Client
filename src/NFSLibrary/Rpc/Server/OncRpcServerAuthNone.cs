...
namespace NFSLibrary.Rpc.Server
{
    ...
    public sealed class OncRpcServerAuthNone : OncRpcServerAuth
    {
        ...
        {
            return NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_NONE;
        }
        ...
        /// is needed.
        /// </remarks>
        public static readonly NFSLibrary.Rpc.Server.OncRpcServerAuthNone AUTH_NONE = new
            NFSLibrary.Rpc.Server.OncRpcServerAuthNone();
    }
}