...
namespace NFSLibrary.Rpc.Server
{
    ...
    public abstract class OncRpcServerStub
    {
        ...
        /// transports an ONC/RPC server offers for handling ONC/RPC calls.
        /// </remarks>
        public NFSLibrary.Rpc.Server.OncRpcServerTransport[] Transports;
        ...
        /// willing to handle.
        /// </remarks>
        public NFSLibrary.Rpc.Server.OncRpcServerTransportRegistrationInfo[] Info;
        ...
        /// successfully.
        /// </exception>
        public virtual void register(NFSLibrary.Rpc.Server.OncRpcServerTransport[] transports
            )
        {
        ...
        /// <see cref="Close(OncRpcServerTransport[])">Close(OncRpcServerTransport[])</see>
        ...
        /// the portmapper.
        /// </exception>
        public virtual void unregister(NFSLibrary.Rpc.Server.OncRpcServerTransport[] transports
            )
        {
            int size = transports.Length;
            for (int idx = 0; idx < size; ++idx)
