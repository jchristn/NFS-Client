...
namespace NFSLibrary.Rpc.Server
{
    ...
    public class OncRpcTcpServerTransport : OncRpcServerTransport
    {
        ...
        public OncRpcTcpServerTransport(NFSLibrary.Rpc.Server.OncRpcDispatchable dispatcher
            , int port, int program, int version, int bufferSize) : this(dispatcher, port, new
            NFSLibrary.Rpc.Server.OncRpcServerTransportRegistrationInfo[] { new NFSLibrary.Rpc.Server.OncRpcServerTransportRegistrationInfo
            (program, version) }, bufferSize)
        {
            openTransports = new NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList
                (this);
        }
        ...
        /// <exception cref="System.IO.IOException"></exception>
        public OncRpcTcpServerTransport(NFSLibrary.Rpc.Server.OncRpcDispatchable dispatcher
            , int port, NFSLibrary.Rpc.Server.OncRpcServerTransportRegistrationInfo[] info
        ...
        /// <exception cref="System.IO.IOException"></exception>
        public OncRpcTcpServerTransport(NFSLibrary.Rpc.Server.OncRpcDispatchable dispatcher
            , IPAddress bindAddr, int port, NFSLibrary.Rpc.Server.OncRpcServerTransportRegistrationInfo
        ...
        /// either terminate directly or when they try to sent back replies.</para>
        /// </remarks>
        public override void Close()
        {
            ...
            lock (openTransports)
            {
                ...
                {
                    NFSLibrary.Rpc.Server.OncRpcTcpConnectionServerTransport transport = (NFSLibrary.Rpc.Server.OncRpcTcpConnectionServerTransport
        ...
        /// </param>
        public virtual void removeTransport(NFSLibrary.Rpc.Server.OncRpcTcpConnectionServerTransport
             transport)
        {
            lock (openTransports)
            {
        ...
        public override void register()
        {
            try
            {
                NFSLibrary.Rpc.OncRpcPortmapClient portmapper = new NFSLibrary.Rpc.OncRpcPortmapClient
                    (IPAddress.Loopback);
                ...
                for (int idx = 0; idx < size; ++idx)
                {
                    ...
                    //
                    if (!portmapper.SetPort(info[idx].program, info[idx].version, NFSLibrary.Rpc.OncRpcProtocols
                        .ONCRPC_TCP, port))
                    {
                        throw (new NFSLibrary.Rpc.OncRpcException(NFSLibrary.Rpc.OncRpcException.RPC_CANNOTREGISTER
                            ));
                    }
                }
            }
            ...
            {
                throw (new NFSLibrary.Rpc.OncRpcException(NFSLibrary.Rpc.OncRpcException.RPC_FAILED
                    ));
            }
        }
        ...
        /// <para>For every incomming TCP/IP connection a handler thread is created
        ...
        private NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList openTransports;
        ...
        /// compatibility.
        /// <para>Note that the methods are not synchronized as we leave this up
        /// to the caller, who can thus optimize access during critical sections.</para>
        /// </remarks>
        private class TransportList
        {
            ...
            {
                this._enclosing = _enclosing;
                head = new NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node(this
                    , null);
                //
            ...
            {
                NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node node = new NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node
                    (this, o);
            ...
            {
                NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node node = this.head
                    .next;
            ...
            /// the special cases of real nodes at the begin or end of the list.
            /// </remarks>
            private NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node head;
            ...
            private class Node
            {
                ...
                /// list is circular.
                /// </remarks>
                internal NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node next;
                ...
                /// list is circular.
                /// </remarks>
                internal NFSLibrary.Rpc.Server.OncRpcTcpServerTransport.TransportList.Node prev;
