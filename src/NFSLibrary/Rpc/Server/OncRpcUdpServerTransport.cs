...
namespace NFSLibrary.Rpc.Server
{
    ...
    public class OncRpcUdpServerTransport : OncRpcServerTransport
    {
        ...
        public OncRpcUdpServerTransport(NFSLibrary.Rpc.Server.OncRpcDispatchable dispatcher
            ...
            [] info, int bufferSize) : base(dispatcher, port, info)
        {
            ...
            // communicate at all.
            //
            sendingXdr = new NFSLibrary.Rpc.XdrUdpEncodingStream(socket, bufferSize);
            receivingXdr = new NFSLibrary.Rpc.XdrUdpDecodingStream(socket, bufferSize);
        }
        ...
        /// and version.</para>
        /// <para>Calling this method on a <code>OncRpcUdpServerTransport</code>
        ...
        /// the close method was called.</para>
        /// </remarks>
