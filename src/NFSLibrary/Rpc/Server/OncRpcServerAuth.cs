...
namespace NFSLibrary.Rpc.Server
{
    ...
    public abstract class OncRpcServerAuth
    {
        ...
        /// <see cref="NFSLibrary.Rpc.OncRpcAuthType">authentication</see>
        /// used.
        /// </summary>
        ...
        public static NFSLibrary.Rpc.Server.OncRpcServerAuth XdrNew(NFSLibrary.Rpc.XdrDecodingStream
             xdr, NFSLibrary.Rpc.Server.OncRpcServerAuth recycle)
        {
            NFSLibrary.Rpc.Server.OncRpcServerAuth auth;
            //
            ...
            else
            {
                switch (authType)
                {
                    case NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_NONE:
                        {
                            ...
                            // the XDR stream.
                            //
                            auth = NFSLibrary.Rpc.Server.OncRpcServerAuthNone.AUTH_NONE;
                            auth.XdrDecodeCredVerf(xdr);
                            break;
                        }
                    ...
                    case NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_SHORT:
                        {
                            auth = new NFSLibrary.Rpc.Server.OncRpcServerAuthShort(xdr);
                            break;
                        }

                    case NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_UNIX:
                        {
                            auth = new NFSLibrary.Rpc.Server.OncRpcServerAuthUnix(xdr);
                            break;
                        }
        ...
        /// (credential and verifier) on the server side.
        /// </summary>
        /// <remarks>
        /// Decodes -- that is: deserializes -- an ONC/RPC authentication object
        /// (credential and verifier) on the server side.
        ...
        /// <exception cref="NFSLibrary.Rpc.OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        public abstract void XdrDecodeCredVerf(NFSLibrary.Rpc.XdrDecodingStream xdr);
        ...
        /// <exception cref="NFSLibrary.Rpc.OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        public abstract void XdrEncodeVerf(NFSLibrary.Rpc.XdrEncodingStream xdr);
    }
}