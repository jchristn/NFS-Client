...
namespace NFSLibrary.Rpc.Server
{
    ...
    public sealed class OncRpcServerAuthUnix : OncRpcServerAuth
    {
        ...
        public OncRpcServerAuthUnix(NFSLibrary.Rpc.XdrDecodingStream xdr)
        {
        ...
        {
            return NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_UNIX;
        }
        ...
        /// <exception cref="NFSLibrary.Rpc.OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        public sealed override void XdrDecodeCredVerf(NFSLibrary.Rpc.XdrDecodingStream
            xdr)
        {
            //
            ...
            if (realLen != len)
            {
                if (realLen < len)
                {
                    throw (new NFSLibrary.Rpc.OncRpcException(NFSLibrary.Rpc.OncRpcException.RPC_BUFFERUNDERFLOW
                        ));
                }
                else
                {
                    throw (new NFSLibrary.Rpc.OncRpcException(NFSLibrary.Rpc.OncRpcException.RPC_AUTHERROR
                        ));
                }
            }
            //
        ...
        /// <exception cref="NFSLibrary.Rpc.OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        public sealed override void XdrEncodeVerf(NFSLibrary.Rpc.XdrEncodingStream xdr)
        {
