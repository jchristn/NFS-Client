...
namespace NFSLibrary.Rpc
{
    ...
    public class OncRpcTcpClient : OncRpcClient
    {
        ...
        /// to the ONC/RPC server at <code>host</code> for calling remote procedures
        /// of the given { program, version }.
        /// <para>Note that the construction of an <code>OncRpcTcpClient</code>
        ...
        public OncRpcTcpClient(IPAddress host, int program, int version, int port
            ...
            : base(host, program, version, port, NFSLibrary.Rpc.OncRpcProtocols
            .ONCRPC_TCP)
        {
            //
            ...
            // Enable address reuse to help with TIME_WAIT sockets
        ...
        public override void Close()
        {
            if (socket != null)
            {
                try
                {
                    // Set linger to 0 to force an abortive close (RST)
                    // This avoids TIME_WAIT state and prevents socket exhaustion
        ...
        /// <para>Please note that while this method supports call batching by
        ...
        /// batch should be flushed to the server.</para>
        /// </remarks>
        ...
        /// <exception cref="OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public override void call(int procedureNumber, int versionNumber, NFSLibrary.Rpc.XdrAble
             @params, NFSLibrary.Rpc.XdrAble result)
        {
            lock (this)
            {
                // Refresh:
        ...
        /// <exception cref="OncRpcException">if an ONC/RPC error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        public virtual void batchCall(int procedureNumber, NFSLibrary.Rpc.XdrAble @params
            , bool flush)
        {
            lock (this)
            {
        ...
        /// 	</see>
        /// will raise a timeout exception. The default timeout value is
        ...
        /// server.
        /// </remarks>
        internal NFSLibrary.Rpc.XdrTcpEncodingStream sendingXdr;
        ...
        /// ONC/RPC server.
        /// </remarks>
        internal NFSLibrary.Rpc.XdrTcpDecodingStream receivingXdr;
