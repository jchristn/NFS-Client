...
namespace NFSLibrary.Rpc
{
    ...
    public class OncRpcDumpResult : NFSLibrary.Rpc.XdrAble
    {
        /// <summary>
        ...
        public virtual void XdrEncode(NFSLibrary.Rpc.XdrEncodingStream xdr)
        {
            ...
            else
            {
                ...
                while (count > 0)
                {
                    ...
                    ((NFSLibrary.Rpc.XdrAble)servers[index]).XdrEncode(xdr);
                    index++;
                    count--;
                }
                xdr.XdrEncodeBoolean(false);
        ...
        public virtual void XdrDecode(NFSLibrary.Rpc.XdrDecodingStream xdr)
        {
            ...
            {
                servers.Add(new NFSLibrary.Rpc.OncRpcServerIdent(xdr));
            }
        }
    }
}