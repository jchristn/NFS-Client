...
namespace NFSLibrary.Rpc
{
    ...
    public class OncRpcClientAuthUnix : NFSLibrary.Rpc.OncRpcClientAuth
    {
        /// <summary>
        ...
        /// protocol handling object capable of handling <code>AUTH_UNIX</code>
        /// and <code>AUTH_SHORT</code>.
        /// <para>Please note that the credential information is typically only
        ...
        internal override void XdrEncodeCredVerf(NFSLibrary.Rpc.XdrEncodingStream xdr)
        {
            if (shorthandCred == null)
            {
                ...
                //
                if ((gids.Length > NFSLibrary.Rpc.OncRpcAuthConstants.ONCRPC_MAX_GROUPS) || (machinename
                    .Length > NFSLibrary.Rpc.OncRpcAuthConstants.ONCRPC_MAX_MACHINE_NAME))
                {
                    throw (new NFSLibrary.Rpc.OncRpcAuthenticationException(NFSLibrary.Rpc.OncRpcAuthStatus
                        .ONCRPC_AUTH_FAILED));
                }
                xdr.XdrEncodeInt(NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_UNIX);
                ...
                if (len > NFSLibrary.Rpc.OncRpcAuthConstants.ONCRPC_MAX_AUTH_BYTES)
                {
                    throw (new NFSLibrary.Rpc.OncRpcAuthenticationException(NFSLibrary.Rpc.OncRpcAuthStatus
                        .ONCRPC_AUTH_FAILED));
                }
            ...
            else
            {
                ...
                //
                xdr.XdrEncodeInt(NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_SHORT);
            ...
            // type AUTH_NONE.
            //
            xdr.XdrEncodeInt(NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_NONE);
            xdr.XdrEncodeInt(0);
        }
        ...
        /// <exception cref="System.IO.IOException">if an I/O error occurs.</exception>
        /// <exception cref="NFSLibrary.Rpc.OncRpcException"></exception>
        internal override void XdrDecodeVerf(NFSLibrary.Rpc.XdrDecodingStream xdr)
        {
            switch (xdr.XdrDecodeInt())
            {
                case NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_NONE:
                    {
                        //
                ...
                case NFSLibrary.Rpc.OncRpcAuthType.ONCRPC_AUTH_SHORT:
                    {
                        //
                        ...
                        if (shorthandCred.Length > NFSLibrary.Rpc.OncRpcAuthConstants.ONCRPC_MAX_AUTH_BYTES)
                        {
                            throw (new NFSLibrary.Rpc.OncRpcAuthenticationException(NFSLibrary.Rpc.OncRpcAuthStatus
                                .ONCRPC_AUTH_FAILED));
                        }
